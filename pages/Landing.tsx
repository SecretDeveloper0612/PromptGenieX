...
export const Landing: React.FC = () => {
  ...
  const faqs = [
    { q: "How does PromptSmith differ from just using ChatGPT?", a: "PromptSmith isn't a chatbot; it's a compiler. We take your intent and run it through an engineering pipeline that injects role-play, constraints, and platform-specific logic to force the AI into high-precision output." },
      ...
      <section className="py-24 px-4 bg-white/[0.01] border-y border-white/5 relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
           <div className="text-center mb-16">
              ...
              <p className="text-gray-500 max-w-xl mx-auto">See how PromptSmith transforms generic requests into industrial-grade instructions.</p>
           </div>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <div className="glass p-8 rounded-[3rem] border-purple-500/20 bg-purple-500/[0.02] shadow-3xl shadow-purple-500/10 relative group border-2">
                 <div className="absolute top-6 right-6 px-3 py-1 bg-purple-500/10 border border-purple-500/20 rounded-full text-[10px] font-black text-purple-400 uppercase tracking-widest">PromptSmith Output</div>
      ...
      <section className="py-32 px-4 border-y border-white/5 bg-white/[0.01]">
        <div className="max-w-7xl mx-auto">
           <div className="text-center mb-24">
              ...
              <p className="text-gray-500 max-w-2xl mx-auto font-medium">PromptSmith is the force multiplier for elite professionals across every domain.</p>
           </div>

           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {useCases.map((useCase, idx) => (
                <div key={idx} className="glass p-12 rounded-[4rem] border-white/5 hover:border-purple-500/20 transition-all group flex flex-col h-full shadow-2xl relative overflow-hidden">
